...
<?php include('menu-page-dark.php'); ?>
	...
	<div id="portfolio" class="page">
    	...
    	<div class="grid-content marg-top-100">
            ...
            <div class="port-list row">
                ...
                <div class="col-1-2 padd-25">
                    <div class="port-item web" style="background-image: url('http://placehold.it/900x563');">
                        <div class="port-caption transit">
                            <div class="port-title marg-top-75 marg-left-25 marg-right-25"><a href="img/portfolio/port-12.jpg" class="lightbox">Item in Lightbox</a></div>
                            <div class="line-center brd-gr2-clr"></div>
        ...
        <div class="header-page padd-y-75">
            ...
            <div class="title-page padd-x-25 fs-clr">portfolio 2 columns spaced</div>
