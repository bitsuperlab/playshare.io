...
jQuery(function($){
	...
	$(document).ready(function() {
		...
		// Markers Setup
		$('#gmap_markers span').each(function(index){
	...
	$(window).load(function() {
		...
		// Add Markers
		$('#gmap_markers span').each(function(){
